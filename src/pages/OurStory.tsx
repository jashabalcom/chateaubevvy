      ...
      <main className="min-h-screen bg-background">
        ...
        <section className="relative h-[60vh] flex items-center justify-center overflow-hidden">
          ...
          >
            <motion.h1 
              variants={heroReveal}
              className="font-serif text-5xl md:text-7xl text-brand-cream mb-4"
            >
              Our Story
            </motion.h1>
            <motion.p 
              variants={heroReveal}
              className="text-brand-cream/70 text-lg md:text-xl max-w-2xl mx-auto"
            >
            ...
            <div className="grid lg:grid-cols-2 gap-16 items-center">
              ...
              >
                ...
                <motion.p 
                  ...
                  className="text-brand-black/80 leading-relaxed mb-6"
                >
              ...
              >
                ...
                <motion.div 
                  ...
                  className="absolute -bottom-8 -left-8 w-48 h-48 bg-brand-gold/10 rounded-sm -z-10" 
                />
              </motion.div>
            </div>
          </div>
          ...
          <div className="container mx-auto px-6 relative z-10">
            <div className="grid lg:grid-cols-2 gap-16 items-center">
              ...
              >
                <motion.div 
                  variants={scaleReveal}
                  className="aspect-[3/4] bg-brand-cream/10 rounded-sm overflow-hidden"
                >
                  <img
        ...
        <section className="py-24 bg-brand-cream">
          <div className="container mx-auto px-6">
            ...
            >
              ...
              <motion.h2 
                variants={fadeUp}
                className="font-serif text-4xl md:text-5xl text-brand-black mt-4"
              >
            ...
            <div className="relative">
              ...
              <motion.div 
                ...
                className="absolute left-1/2 transform -translate-x-1/2 w-px h-full bg-brand-gold/30 hidden md:block origin-top" 
              />
              ...
              <div className="space-y-12">
                {timelineEvents.map((event, index) => (
                  ...
                  >
                    ...
                    <motion.div 
                      variants={timelineDotReveal}
                      className="w-4 h-4 rounded-full bg-brand-gold ring-4 ring-brand-gold/20 z-10" 
                    />
        ...
        <section className="py-24 bg-brand-black">
          <div className="container mx-auto px-6 text-center max-w-4xl">
            ...
            >
              ...
              <motion.h2 
                variants={heroReveal}
                className="font-serif text-4xl md:text-5xl text-brand-cream mt-4 mb-8"
              >
                "Feels Like Home, Tastes Like the World"
              </motion.h2>
              <motion.p 
                variants={fadeUpSmall}
                className="text-brand-cream/80 text-lg leading-relaxed"
              >
