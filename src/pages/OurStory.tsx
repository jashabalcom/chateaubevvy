      ...
      <main className="min-h-screen bg-background">
        ...
        <section className="py-24 bg-cream">
          <div className="container mx-auto px-6">
            <div className="grid lg:grid-cols-2 gap-16 items-center">
              ...
              >
                <span className="text-gold uppercase tracking-widest text-sm">The Building</span>
        ...
        <section className="py-24 bg-wine-dark relative overflow-hidden">
          <div className="absolute inset-0 opacity-5">
            <div className="absolute inset-0 bg-[radial-gradient(circle_at_30%_50%,_var(--tw-gradient-stops))] from-gold to-transparent" />
          </div>
          <div className="container mx-auto px-6 relative z-10">
            <div className="grid lg:grid-cols-2 gap-16 items-center">
              ...
              >
                <span className="text-gold uppercase tracking-widest text-sm">The Founder</span>
        ...
        <section className="py-24 bg-cream">
          <div className="container mx-auto px-6">
            ...
            >
              <span className="text-gold uppercase tracking-widest text-sm">Our Journey</span>
            ...
            <div className="relative">
              {/* Timeline line */}
              <div className="absolute left-1/2 transform -translate-x-1/2 w-px h-full bg-gold/30 hidden md:block" />
                ...
                {timelineEvents.map((event, index) => (
                  ...
                  >
                    <div className={`flex-1 ${index % 2 === 0 ? "md:text-right" : "md:text-left"}`}>
                      <span className="font-serif text-3xl text-gold">{event.year}</span>
                      <h3 className="font-serif text-2xl text-wine-dark mt-2">{event.title}</h3>
                      <p className="text-charcoal/70 mt-2">{event.description}</p>
                    </div>
                    <div className="w-4 h-4 rounded-full bg-gold ring-4 ring-gold/20 z-10" />
        ...
        <section className="py-24 bg-wine-dark">
          <div className="container mx-auto px-6 text-center max-w-4xl">
            <motion.div
              ...
              viewport={{ once: true }}
            >
              <span className="text-gold uppercase tracking-widest text-sm">Our Vision</span>
